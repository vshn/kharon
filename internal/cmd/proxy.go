...
func init() {
	...
	flag.StringVar(&proxyMappingFile, "mapping-file", proxyMappingFilePath(), "Path to the domain to jumphost mapping file. This file is generated by the querier and should be kept up to date. The proxy will watch for SIGHUP to reload the mapping without restarting.")
